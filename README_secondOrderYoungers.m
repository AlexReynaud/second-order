...
load('dataset_secondOrderYoungers.mat')
data
...
%   struct with fields:
% 
%     sensitivities1st: [2×9×2×52 double]
%     sensitivities2nd: [3×9×2×52 double]
...
%% example plot of the dominant eye sensitivities in the young population

figure('Name','1st- and 2nd-order sensitivities in the young population')
hold on
